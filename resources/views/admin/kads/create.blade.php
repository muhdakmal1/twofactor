...
<div class="card">
    <div class="card-body">
        ...
        <hr>
        <form action="{{ route("admin.kads.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            {{-- @method('PUT') --}}
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('couple_name') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="couple_name" name="couple_name" class="form-control" required>
                ...
                <div class="col-md-6" style="text-align: center;">
                    ...
                    <div class="col-md-12">
                        <div class="file-input form-group {{ $errors->has('url_img') ? 'has-error' : '' }}" style="text-align: center;">
                            ...
                            <input type="file" id="url_img2" name="url_img2" class="file-input__input form-control">
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('intro_desc') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="intro_desc" name="intro_desc" class="form-control" required>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('location_short') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="location_short" name="location_short" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('time_event1') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="time_event1" name="time_event1" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('time_event2') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="time_event2" name="time_event2" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('time_event3') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="time_event3" name="time_event3" class="form-control" required>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('date_event') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="date_event" name="date_event" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('timedec_event1') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="timedec_event1" name="timedec_event1" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('timedec_event2') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="timedec_event2" name="timedec_event2" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('timedec_event3') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="timedec_event3" name="timedec_event3" class="form-control" required>
                ...
                <div class="col-md-4">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_person1') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_person1" name="contact_person1" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_person2') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_person2" name="contact_person2" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_person3') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_person3" name="contact_person3" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_person4') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_person4" name="contact_person4" class="form-control" >
                ...
                <div class="col-md-4">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_no1') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_no1" name="contact_no1" class="form-control"  required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_no2') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_no2" name="contact_no2" class="form-control"  required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_no3') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_no3" name="contact_no3" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_no4') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_no4" name="contact_no4" class="form-control" >
                ...
                <div class="col-md-4">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_relation1') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_relation1" name="contact_relation1" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_relation2') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_relation2" name="contact_relation2" class="form-control"  required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_relation3') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_relation3" name="contact_relation3" class="form-control"  required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact_relation4') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="contact_relation4" name="contact_relation4" class="form-control" >
                ...
                <div class="col-md-12">
                        ...
                        <div class="form-group {{ $errors->has('music_id') ? 'has-error' : '' }}">
                            ...
                            <select name="music_id" id="music_id" class="form-control select2" required>
                                @foreach($music as $id => $music)
                                    <option value="{{ $id }}"> {{ $music->music_title }} - {{ $music->music_author }} </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('googlemap_url') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="googlemap_url" name="googlemap_url" class="form-control"  required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('wazemap_url') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="wazemap_url" name="wazemap_url" class="form-control"  required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('google_calendar') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="google_calendar" name="google_calendar" class="form-control" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('apple_calendar') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="apple_calendar" name="apple_calendar" class="form-control"  required>
