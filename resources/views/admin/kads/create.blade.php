...
<div class="card">
    <div class="card-body">
        ...
        <hr>
        @if($errors->any())
            <div class="alert alert-dismissible" style="color: red; text-align: center;">
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="text-align: center;">
                    <div class="col-md-12 container mb-3">
                        <img id="blah" style="width: 300px; height: 300px;">
                    </div>
                    <div class="col-md-12">
                        <div class="file-input form-group {{ $errors->has('url_img') ? 'has-error' : '' }}" style="text-align: center;">
                            ...
                            <input type="file" id="url_img" onchange="readURL(this);" name="url_img" class="file-input__input form-control" required>
                ...
                {{-- <div class="col-md-12">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('intro_desc') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="intro_desc" name="intro_desc" class="form-control" value="Assalamualaikum Warahmatullahi Wabarakatuh Dengan penuh kesyukuran kami," hidden>
...
<script type="text/javascript">
    $(function () {
        ...
        // $("#customer_name, #customer_email, #couple_name, #father_name, #mother_name, #timedec_event1, #timedec_event2, "
        // +"#timedec_event3, #contact_person1, #contact_person2, #contact_person3, #contact_relation1, #contact_relation2, "
        // +"#contact_relation3, #googlemap_link, #wazemap_url").val("test");
        // $("#contact_no1, #contact_no2, #contact_no3").val("0000000000");
    });
