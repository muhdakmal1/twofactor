                ...
                <div class="weddingcard card-cps">
                    ...
                    <div class="divTwo text-center">
                        ...
                        <div class="layoutJemputan" style="{{ $color_layoutjemputan->css }}">
                            ...
                            data-aos-mirror="true"
                            data-aos-once="false">
                            @if( $template_data->layoutParents == null )
                            <p>{{ $template_data->father_name }}</p>
                            <p style="font-style:italic">dan</p>
                            <p>{{ $template_data->mother_name }}</p>
                            @else
                            {!! $template_data->layoutParents !!}
                            @endif
                            </div>
                        </div>
                        <div data-aos="fade-in" 
                            ...
                            data-aos-mirror="true"
                            data-aos-once="false">
                            @if( $template_data->textJemputan == null )
                            <p>
                            ...
                            @else
                                {!! $template_data->textJemputan !!}
                            @endif
                        </div>
                        <div class="layoutPengantin" style="{{ $color_layoutPengantin->css }}">
                        ...
                        <div class="Calendar_custom">
                            ...
                            <div class="catCalendar">
                                <p style="text-align:center">
                                    <a 
                                    class="textCalendar"
                                        href="{{ $template_data->google_calendar }}"
                                        target="_blank"
                                    >
                                        Google Calendar
                        ...
                        <div class="Calendar_custom">
                            ...
                            <div style="padding:0px 20px">
                                ...
                                <div class="catLocation">
                                    ...
                                    <a 
                                        href="{{ $template_data->googlemap_link }}"
                                        target="_blank"
                                        class="textLocation"
